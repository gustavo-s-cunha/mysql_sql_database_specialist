...
--
-- Current Database: `ecomerce`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ecomerce` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`fpmaster`@`%`*/ /*!50003 TRIGGER `trg_before_delete_cliente` BEFORE DELETE ON `cliente` FOR EACH ROW BEGIN
...
CREATE TABLE `endereco` (
  ...
  KEY `idx_endereco_cidade` (`cidade`),
  CONSTRAINT `fk_endereco_Cliente1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`)
...
CREATE TABLE `entrega` (
  ...
  `situacao` enum('Processando','Enviado','Entregue') DEFAULT NULL,
  ...
  KEY `idx_entrega_idEndereco` (`idEndereco`),
  CONSTRAINT `fk_entrega_endereco1` FOREIGN KEY (`idEndereco`) REFERENCES `endereco` (`idendereco`),
  CONSTRAINT `fk_entrega_Pedido1` FOREIGN KEY (`idPedido`) REFERENCES `pedido` (`idPedido`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `historico_colaborador`
--

DROP TABLE IF EXISTS `historico_colaborador`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historico_colaborador` (
  `idResponsavel` int DEFAULT NULL,
  `Nome` varchar(45) DEFAULT NULL,
  `Cargo_anterior` varchar(45) DEFAULT NULL,
  `Cargo_atual` varchar(45) DEFAULT NULL,
...
CREATE TABLE `ordem_servico` (
  ...
  KEY `fk_Ordem de Servico_Pedido_has_Responsavel1_idx` (`Pedido_has_Responsavel_Pedido_idPedido`,`Pedido_has_Responsavel_Responsavel_idResponsavel`),
  CONSTRAINT `fk_Ordem de Servico_Pedido_has_Responsavel1` FOREIGN KEY (`Pedido_has_Responsavel_Pedido_idPedido`, `Pedido_has_Responsavel_Responsavel_idResponsavel`) REFERENCES `pedido_gerado` (`Pedido_idPedido`, `Responsavel_idResponsavel`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pagamento` (
  ...
  `tipo` enum('Cartão','Boleto','Pix') DEFAULT NULL,
  `detalhes` varchar(150) DEFAULT NULL,
  `codigo` varchar(45) NOT NULL,
  `data_vencimento` date DEFAULT NULL,
  `idCliente` int NOT NULL,
  PRIMARY KEY (`idpagamento`),
  KEY `fk_pagamento_Cliente1_idx` (`idCliente`),
  CONSTRAINT `fk_pagamento_Cliente1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedido` (
  ...
  `Título_pedido` varchar(45) DEFAULT NULL,
  `Tipo_problema` varchar(50) DEFAULT NULL,
  `Prioridade` enum('Baixa','Média','Alta') DEFAULT 'Baixa',
  PRIMARY KEY (`idPedido`),
  KEY `fk_Pedido_Cliente2_idx` (`idCliente`),
  CONSTRAINT `fk_Pedido_Cliente2` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedido_gerado` (
  ...
  KEY `fk_Pedido_has_Responsavel_Responsavel1_idx` (`Responsavel_idResponsavel`),
  KEY `fk_Pedido_has_Responsavel_Pedido1_idx` (`Pedido_idPedido`),
...
--
-- Table structure for table `produto_estoque_local`
--

DROP TABLE IF EXISTS `produto_estoque_local`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `produto_vendedor_terceiro`
--

DROP TABLE IF EXISTS `produto_vendedor_terceiro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `produto_vendedor_terceiro` (
  ...
  KEY `fk_Terceiro_Vendedor_has_Produto_Produto1_idx` (`Produto_idProduto`),
  KEY `fk_Terceiro_Vendedor_has_Produto_Terceiro_Vendedor1_idx` (`idPseller`),
  KEY `idx_vendedor_produto` (`Produto_idProduto`),
  CONSTRAINT `fk_Terceiro_Vendedor_has_Produto_Produto1` FOREIGN KEY (`Produto_idProduto`) REFERENCES `produto` (`idProduto`),
  CONSTRAINT `fk_Terceiro_Vendedor_has_Produto_Terceiro_Vendedor1` FOREIGN KEY (`idPseller`) REFERENCES `vendedor_terceiro` (`idTerceiro_Vendedor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `responsavel` (
  ...
  `Matrícula` varchar(45) DEFAULT NULL,
  `Cargo` varchar(45) DEFAULT NULL,
  `Nome` varchar(100) NOT NULL,
  PRIMARY KEY (`idResponsavel`),
  UNIQUE KEY `Matrícula_UNIQUE` (`Matrícula`),
  KEY `idx_responsavel_setor` (`Setor`)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`fpmaster`@`%`*/ /*!50003 TRIGGER `trg_before_update_responsavel` BEFORE UPDATE ON `responsavel` FOR EACH ROW BEGIN
...
--
-- Temporary view structure for view `vw_ordens_por_setor`
--

DROP TABLE IF EXISTS `vw_ordens_por_setor`;
/*!50001 DROP VIEW IF EXISTS `vw_ordens_por_setor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_ordens_por_setor` AS SELECT 
 1 AS `Setor_responsavel`,
 1 AS `idOrdemServico`,
 1 AS `Descricao`,
 1 AS `Prioridade`*/;
...
--
-- Temporary view structure for view `vw_pedidos_por_endereco_setor`
--

DROP TABLE IF EXISTS `vw_pedidos_por_endereco_setor`;
/*!50001 DROP VIEW IF EXISTS `vw_pedidos_por_endereco_setor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_pedidos_por_endereco_setor` AS SELECT 
 1 AS `cidade`,
 1 AS `setor`,
 1 AS `total_pedidos`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vw_produto_estoque_fornecedor`
--

DROP TABLE IF EXISTS `vw_produto_estoque_fornecedor`;
/*!50001 DROP VIEW IF EXISTS `vw_produto_estoque_fornecedor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_produto_estoque_fornecedor` AS SELECT 
 1 AS `produto`,
 1 AS `local_estoque`,
 1 AS `fornecedor`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vw_responsaveis_por_setor`
--

DROP TABLE IF EXISTS `vw_responsaveis_por_setor`;
/*!50001 DROP VIEW IF EXISTS `vw_responsaveis_por_setor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_responsaveis_por_setor` AS SELECT 
 1 AS `Setor`,
 1 AS `total_responsaveis`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vw_top_produtos_pedidos`
--

DROP TABLE IF EXISTS `vw_top_produtos_pedidos`;
/*!50001 DROP VIEW IF EXISTS `vw_top_produtos_pedidos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_top_produtos_pedidos` AS SELECT 
 1 AS `Descricao`,
 1 AS `total_pedidos`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `vw_ordens_por_setor`
--
...
/*!50013 DEFINER=`fpmaster`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_ordens_por_setor` AS select `pg`.`Setor_responsavel` AS `Setor_responsavel`,`os`.`idOrdemServico` AS `idOrdemServico`,`os`.`Descricao` AS `Descricao`,`os`.`Prioridade` AS `Prioridade` from (`ordem_servico` `os` join `pedido_gerado` `pg` on(((`os`.`Pedido_has_Responsavel_Pedido_idPedido` = `pg`.`Pedido_idPedido`) and (`os`.`Pedido_has_Responsavel_Responsavel_idResponsavel` = `pg`.`Responsavel_idResponsavel`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_pedidos_por_endereco_setor`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fpmaster`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_pedidos_por_endereco_setor` AS select `e`.`cidade` AS `cidade`,`pg`.`Setor_responsavel` AS `setor`,count(`p`.`idPedido`) AS `total_pedidos` from ((`pedido` `p` join `endereco` `e` on((`p`.`idCliente` = `e`.`idCliente`))) join `pedido_gerado` `pg` on((`p`.`idPedido` = `pg`.`Pedido_idPedido`))) group by `e`.`cidade`,`pg`.`Setor_responsavel` order by `pg`.`Setor_responsavel` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_produto_estoque_fornecedor`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fpmaster`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_produto_estoque_fornecedor` AS select `pr`.`Descricao` AS `produto`,`es`.`Local` AS `local_estoque`,`f`.`Razao_Social` AS `fornecedor` from ((((`produto` `pr` join `produto_fornecedor` `pf` on((`pr`.`idProduto` = `pf`.`Produto_idProduto`))) join `fornecedor` `f` on((`pf`.`Fornecedor_idFornecedor` = `f`.`idFornecedor`))) left join `produto_estoque_local` `pel` on((`pr`.`idProduto` = `pel`.`Produto_idProduto`))) left join `estoque` `es` on((`pel`.`Estoque_idEstoque` = `es`.`idEstoque`))) order by `pr`.`Descricao` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_responsaveis_por_setor`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fpmaster`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_responsaveis_por_setor` AS select `responsavel`.`Setor` AS `Setor`,count(`responsavel`.`idResponsavel`) AS `total_responsaveis` from `responsavel` group by `responsavel`.`Setor` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_top_produtos_pedidos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fpmaster`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_top_produtos_pedidos` AS select `pr`.`Descricao` AS `Descricao`,count(`pp`.`idProdutoPedido`) AS `total_pedidos` from (`produto` `pr` join `produto_pedido` `pp` on((`pr`.`idProduto` = `pp`.`Produto_idProduto`))) group by `pr`.`idProduto` order by `total_pedidos` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-04-16 14:17:44
